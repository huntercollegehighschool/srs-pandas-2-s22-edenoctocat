...
"""
scorephrases = ign['score_phrase']
allphrases = scorephrases.unique()
print(scorephrases)
print(allphrases)
...
"""
numberofeach = scorephrases.value_counts()
print(numberofeach)
...
"""
unbearablescore = ign[ign['score_phrase'] == 'Unbearable']['score'].mean()
painfulscore = ign[ign['score_phrase'] == 'Painful']['score'].mean()
print(unbearablescore)
print(painfulscore)

for phrase in allphrases:
  print(phrase, ign[ign["score_phrase"] == phrase]["score"].mean())

"""
6. Use the .value_counts() function to determine which year in the dataset had the most game releases.
"""
years = ign['release_year'].value_counts()
print(years)

"""
7. Use the .value_counts() function to determine in which month most games are released.
"""
months = ign['release_month'].value_counts()
print(months)
...
"""
platforms = ign['platform'].unique()
print(platforms)

for platform in platforms:
  print(platform, ign[ign['platform'] == platform]['score'].mean())
...
"""
zeldagames = ign[ign.index.str.contains('Zelda')]
print(zeldagames)
pokemongames = ign[ign.index.str.contains('Pokemon')]
print(pokemongames)
...
"""
pokemonsorted = pokemongames.sort_values(by = ['score'], ascending = False)
print(pokemonsorted)